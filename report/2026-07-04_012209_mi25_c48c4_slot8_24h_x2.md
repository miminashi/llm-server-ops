...
- **副次観測**: pp_tps は R1 206.19 / R2 230.43 t/s で前回 8h 版 (255.4 t/s) より更に低下、stand_alone_24h の 508.9 t/s の 40-45% に留まる = eval_tps は完全整合するが pp が構造的に低い、原因未追究
- **副次観測**: 本試験期間中 BACO recovery 発生 0 件 = power p95 = cap 通り 161W 維持、Tj max 93-95°C = stand_alone_24h と整合
...
### 副次観測: pp_tps 半減の継続確認 ([副次発見#2](#副次発見-2-pp_tps-半減の継続確認))
...
| **性能 (pp_tps)** | **SA の 40-45%、SLOT8 化で低下継続** | 副次発見 #2 参照、要追検 |

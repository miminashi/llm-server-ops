...
#   server     - Server name (mi25, t120h-p100, t120h-m10, aws-gpu01, aws-gpu02, or aws-v100)
...
VALID_SERVERS="mi25 t120h-p100 t120h-m10 aws-gpu01 aws-gpu02 aws-v100"
SSH_OPTS="-o ConnectTimeout=5 -o BatchMode=yes"

# Parse arguments
if [ $# -lt 1 ]; then
    echo "Usage: $0 <server> [session_id]" >&2
    echo "  server: mi25, t120h-p100, t120h-m10, aws-gpu01, aws-gpu02, or aws-v100" >&2
    exit 2
fi

...
usage() {
    ...
    echo ""
    echo "Arguments:"
    echo "  src-server  転送元サーバ (mi25, t120h-p100, t120h-m10, aws-gpu01, aws-gpu02, aws-v100)"
    echo "  src-path    転送元ファイルパス（絶対パスまたは~からの相対パス）"
    echo "  dst-server  転送先サーバ (mi25, t120h-p100, t120h-m10, aws-gpu01, aws-gpu02, aws-v100)"
